...
class Views_Plugin implements Typecho_Plugin_Interface
{
     ...
     * @return string
     */
    public static function theMostViewed($limit = 5, $before = '', $after = ' Views')
    {
        $db = Typecho_Db::get();
        ...
        if ($posts) {
            foreach ($posts as $post) {
                ...
                echo "<li><time>$before $post_views $after</time><a href='$permalink' title='$post_title'>$post_title</a></li>";
            }
