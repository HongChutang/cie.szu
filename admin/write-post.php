            ...
            <form action="<?php $security->index('/action/contents-post-edit'); ?>" method="post" name="write_post">
                <div class="col-mb-12 col-tb-9" role="main">
                    ...
                    <p class="submit clearfix">
                        <span class="right">
                            ...
                            <button type="submit" name="do" value="publish" class="btn primary" id="btn-submit"><?php _e('提交修改'); ?></button>
                ...
                <div id="edit-secondary" class="col-mb-12 col-tb-3" role="complementary">
                    <ul class="typecho-option-tabs clearfix">
                        ...
                        <li class="w-50"><a href="#tab-files" id="tab-files-btn"><?php _e('上传附件'); ?></a></li>
                    </ul>
                    ...
                    <div id="tab-advance" class="tab-content">
                        ...
                        <section class="typecho-post-option category-option">
                            <label class="typecho-label"><?php _e('请选择分类'); ?></label>
