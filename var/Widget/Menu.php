...
class Widget_Menu extends Typecho_Widget
{
    ...
    public function execute()
    {
        ...
        array(
            array(_t('后台主页'), _t('基本信息'), 'index.php', 'subscriber'),
        ...
        array(
            ...
            array(_t('创建页面'), _t('创建新页面'), 'write-page.php', 'administrator', false, 'user.php'),
        ...
        array(
            ...
            array(_t('独立页面'), _t('管理独立页面'), 'manage-pages.php', 'administrator', false, 'user.php'),
            array(_t('评论'), _t('管理评论'), 'manage-comments.php', 'administrator', false, 'user.php'),
            ...
            array(_t('标签'), _t('管理标签'), 'manage-tags.php', 'administrator', false, 'user.php'),
